#!/usr/bin/env python3
"""
First-Time Visualization Runner for CARLA DRL Pipeline

This script orchestrates the complete system startup for first-time
real-time visualization of the DRL training process. It manages
all components automatically and provides comprehensive monitoring.

Author: GitHub Copilot
Date: August 2025
Enhanced for first-time user experience with real-time camera visualization
"""
...
class ComponentManager:
    """Enhanced component manager with health monitoring and restart capabilities"""

    def __init__(self, name: str, command: List[str], working_dir: str = None,
                 env_vars: Dict[str, str] = None, wait_time: float = 5.0):
        self.name = name
...
class VisualizationRunner:
    """Enhanced orchestrator for CARLA DRL first-time visualization"""
    ...
    def __init__(self, base_path: str):
        ...
        # Monitoring
        self.status_update_interval = 5.0
    ...
    def _load_config(self) -> Dict:
        ...
        config_path = self.base_path / "configs" / "complete_system_config.yaml"
