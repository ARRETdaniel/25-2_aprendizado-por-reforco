...
docker run --rm --network host --runtime nvidia \
  ...
  bash -c "source /opt/ros/humble/setup.bash && \
           python3 scripts/evaluate_baseline.py \
             ...
             --debug" \
  2>&1 | tee docs/day-25/migration/test_baseline_ros2-bridge.log
---
...
cd /media/danielterra/Windows-SSD/Users/danie/Documents/Documents/MESTRADO/25-2_aprendizado-por-reforco/Detalhamento/av_td3_system && docker run --rm --gpus all --network=host \
  ...
  -w /workspace \
  --privileged \
  av-td3-system:ubuntu22.04-test python3 scripts/evaluate_baseline.py --use-ros-bridge --num-episodes 1 2>&1 | tee test_ros2_bridge_final.log
...
docker run --rm \
  ...
  -v $(pwd):/workspace \
  -w /workspace \
  av-td3-system:ubuntu22.04-test python3 -c "
import logging
logging.basicConfig(level=logging.DEBUG)
print('Testing rclpy import...')
import rclpy
print('SUCCESS: rclpy imported!')
from src.utils.ros_bridge_interface import ROSBridgeInterface
print('SUCCESS: ROSBridgeInterface imported!')
print(f'ROS2_AVAILABLE: {ROSBridgeInterface.__module__}')
