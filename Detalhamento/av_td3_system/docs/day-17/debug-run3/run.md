...
cd /media/danielterra/Windows-RADO/25-2_aprendizado-por-reforco/Detalhamento/av_td3_system && \
docker r host --runtime nvidia \
  ...
  python3 scripts/train_td3.py \
    ...
    --seed 42 \
    --device cpu \
    2>&1 | tee validation_5k_post_all_fixes_2_$(date +%Y%m%d_%H%M%S).log
